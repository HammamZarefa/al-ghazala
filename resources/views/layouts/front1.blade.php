...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('front/css/colors.css')}}" />
...
<div class="acacia-anim ">
    <div><img src="{{asset('front/img/logo/acacia-icon1.png')}}" alt=""></div>
    <div><img src="{{asset('front/img/logo/acacia-icon1.png')}}" alt=""></div>
    <div><img src="{{asset('front/img/logo/acacia-icon1.png')}}" alt=""></div>
    <div><img src="{{asset('front/img/logo/acacia-icon1.png')}}" alt=""></div>
    <div><img src="{{asset('front/img/logo/acacia-icon1.png')}}" alt=""></div>
...
<div class="whatsapp">
    <img src="{{asset('front/img/logo/acacia-icon2.png')}}" alt="">
                    ...
                    <li class="wow fadeInDown" data-wow-duration="0.8s" data-wow-delay="0.6s">
                        <div class="social">
                            <ul>
                                ...
                                <li>
                                    <a href="#">
                                        <span class="first"><img class="svg" src="{{asset('front/img/svg/social/vk.svg')}}" alt="" /></span>
                                        <span class="second"><img class="svg" src="{{asset('front/img/svg/social/vk.svg')}}" alt="" /></span>
                                    </a>
                                </li>
                            </ul>
                        </div>
