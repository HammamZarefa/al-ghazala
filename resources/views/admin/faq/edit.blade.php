            ...
            @foreach(Config::get('app.languages') as $lang)
                <div class="tab-pane fade {{$lang == 'en' ? "show  active" : ""}}" id="{{$lang}}" role="tabpanel"
                    ...
                    <div class="form-group ml-5">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name='question_{{$lang}}'
                                   ...
                                   value="{{old('question_'.$lang) ? old('question_'.$lang) : $faq->getTranslation('question',$lang)}}" id="question_{{$lang}}" placeholder="Question {{$lang}}">
                    ...
                    <div class="form-group ml-5">
                        ...
                        <div class="col-sm-7">
                            <textarea name='answer_{{$lang}}' class="form-control {{$errors->first('answer_'.$lang) ? "is-invalid" : "" }} " id="answer_{{$lang}}" placeholder="Answer {{$lang}}">{{old('answer_'.$lang) ? old('answer_'.$lang) : $faq->getTranslation('answer',$lang)}}</textarea>
                            <div class="invalid-feedback">
