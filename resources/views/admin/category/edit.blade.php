            ...
            @foreach(Config::get('app.languages') as $lang)
                <div class="tab-pane fade {{$lang == 'en' ? "show  active" : ""}}" id="{{$lang}}" role="tabpanel"
                    ...
                    <div class="form-group ml-5">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name='name_{{$lang}}'
                                   ...
                                   value="{{old('name_'.$lang) ? old('name_'.$lang) : $category->getTranslation('name',$lang)}}" id="name_{{$lang}}" placeholder="Name {{$lang}}">
                    ...
                    <div class="form-group ml-5">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name='keyword_{{$lang}}' class="form-control {{$errors->first('keyword_'.$lang) ? "is-invalid" : "" }} " value="{{old('keyword_'.$lang) ? old('keyword_'.$lang) : $category->getTranslation('keyword',$lang)}}" id="keyword_{{$lang}}" placeholder="Keyword {{$lang}}">
                            <div class="invalid-feedback">
                    ...
                    <div class="form-group ml-5">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name='meta_desc_{{$lang}}' class="form-control {{$errors->first('meta_desc_'.$lang) ? "is-invalid" : "" }} " value="{{old('meta_desc_'.$lang) ? old('meta_desc_'.$lang) : $category->getTranslation('meta_desc',$lang)}}" id="meta_desc_{{$lang}}" placeholder="Meta Description {{$lang}}">
                            <div class="invalid-feedback">
