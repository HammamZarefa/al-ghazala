        ...
        <div class="form-group">
            ...
            <div class="picture-container">
                ...
                <div class="picture">
                    ...
                    <input type="file" id="wizard-picture" name="icon" class="form-control {{$errors->first('icon') ? "is-invalid" : "" }} " value="{{old('icon') ? old('icon') : $service->icon}}">
            ...
            @foreach(Config::get('app.languages') as $lang)
                <div class="tab-pane fade {{$lang == 'en' ? "show  active" : ""}}" id="{{$lang}}" role="tabpanel"
                    ...
                    <div class="form-group ml-5">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name='title_{{$lang}}'
                                   ...
                                   value="{{old('title') ? old($service->getTranslation('title',$lang)) : $service->getTranslation('title',$lang)}}" placeholder="Title {{$lang}}">
                            <div class="invalid-feedback">
                                {{ $errors->first('title') }}
                            </div>
                        </div>
                    ...
                    <div class="form-group ml-5">
                        ...
                        <div class="col-sm-7">
                            <input type="text" name='quote_{{$lang}}'
                                   ...
                                   value="{{old('quote') ? old($service->getTranslation('quote',$lang)) : $service->getTranslation('quote',$lang)}}" id="quote_{{$lang}}" placeholder="Quote {{$lang}}">
                            <div class="invalid-feedback">
                                {{ $errors->first('quote') }}
                            </div>
                        </div>
                    ...
                    <textarea name="desc_{{$lang}}" id="desc_{{$lang}}" cols="30" rows="10"
                              ...
                              id="summernote">{{old('desc') ? old($service->getTranslation('desc',$lang)) : $service->getTranslation('desc',$lang)}}</textarea>
                            <div class="invalid-feedback">
                                {{ $errors->first('desc') }}
                            </div>
                        </div>
        ...
        <div class="form-group ml-5">
            ...
            <div class="col-sm-7">
                <input type="text" name='slug'
                       ...
                       value="{{old('slug') ? old('slug') : $service->slug}}" id="slug" placeholder="Slug">
                <div class="invalid-feedback">
                    {{ $errors->first('slug') }}
                </div>
            </div>
